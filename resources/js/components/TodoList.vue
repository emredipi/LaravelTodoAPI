<template>
    <div class="card col-md-6 offset-md-3">
        <div class="card-header h1">{{ editTags ? "Tags" : "Todo List" }}
            <button class="btn float-right" :class="{'btn-warning':editTags, 'btn-outline-warning':!editTags}"
                    @click="toggleTags">
        ...
        <div class="card-body">
            ...
            <form class="form-inline" @submit.prevent="editTags?addNewTag():addNewTodo()">
                <div class="input-group w-100">
                    <input class="form-control-lg" type="text" autofocus placeholder="Type..." v-model="input"
                           style="width: 85%">
